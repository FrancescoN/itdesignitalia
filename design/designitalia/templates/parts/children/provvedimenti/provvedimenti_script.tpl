...
<script>
    ...
    var facet_attributes = "numero|anno|proponente|struttura_competente";
    ...
    $(document).ready(function(){
        ...
        $("#prv_datatable_content").on('xhr.dt', function(e, settings, result, xhr){
            // numero|anno|proponente|struttura_competente
            // Parto dall'indice 1 poiché lo 0 è usato solo in ricerca ma non è visualizzata la faccetta
            setSelectFacet( (result.FacetFields !== null?result.FacetFields[1]:null), $("#anno"), result.GET['anno'] );
            ...
            if(localStorage.getItem('anno') !== null){
                $("#anno").val( localStorage.getItem('anno') );
                $("#anno").hide();

                $("#anno_value").html( localStorage.getItem('anno') );
                $("#anno_choosen").show();
            }
            if(localStorage.getItem('proponente') !== null){
                $("#proponente").val( localStorage.getItem('proponente') );
                $("#proponente").hide();

                $("#proponente_value").html( localStorage.getItem('proponente') );
        ...
        function search(event){
            ...
            if($("#anno").val() !== ''){
                localStorage.setItem('anno', $("#anno").val());
            }
            else{
            ...
            if($("#proponente").val() !== ''){
                localStorage.setItem('proponente', $("#proponente").val());
            }
            else{
                localStorage.removeItem('proponente');
            }
