                ...
                <div class="u-facet-form-cell">
                    <div class="Form-field Form-field--withPlaceholder Grid">
                        <select class="Form-input Grid-cell u-sizeFill u-text-r-s u-border-none" 
                                id="tematica" 
                                name="tematica"
                                data-placeholder="{'Theme'|i18n('designitalia/full')}">
                            <option value="" selected>{'Theme'|i18n('designitalia/full')}</option>
                        </select>
...
{include uri="design:parts/children/circolare/circolare_script.tpl"}