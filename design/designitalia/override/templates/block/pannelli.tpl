{set_defaults( hash(
    ...
    'block_columns', 1,
    'column_index', 0,
    'panel_background', 'u-background-40',
    'sort', 'name',
...
<div class="Panels {$block_background} u-layout-centerContent u-padding-r-top">
    <section class="u-layout-wide u-layout-r-withGutter u-text-r-s u-padding-r-top u-padding-r-bottom">
        ...
        {foreach $items as $index => $item}
            <div class="Item {$column_class}">
                <div class="Panel u-color-white u-padding-all-l u-margin-all-xs u-borderRadius-xxs {$panel_background}">
                    <div class="title">
            ...
            {if $index|sum(1)|eq($block_columns)}
                {set $panel_background = 'u-background-30'}
            {/if}
        {/foreach}
        </div>
